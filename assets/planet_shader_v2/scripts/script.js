...
(async function () {  // Enables async/await in JS [part 1]
  ...
  // Diagnostics.log(newPosition);

  T.onTap().subscribe(async (gesture) => {
    // const newPosition = await Patches.outputs.getVector("tapPosition");
  	...
  	// block.transform.x = newPosition.x;
  	// block.transform.y = 0;
  	// block.transform.z = newPosition.y;
